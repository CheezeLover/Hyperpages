...
export function ServiceColumn({ isPortraitMode, pages, selectedPage, onSelectPage, onExportPdf, isExporting, adminOpen, onOpenAdmin, onDisconnect }: ServiceColumnProps) {
  ...
  return (
    ...
    >
      ...
      {!isFullscreen && <ServiceBtn active={adminOpen} tooltip="Admin settings" onClick={onOpenAdmin} colorScheme="secondary" isPortrait={isPortraitMode}>
        <svg viewBox="0 0 24 24" width={20} height={20} fill="currentColor">
