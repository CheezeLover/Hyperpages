  ...
  return (
    <>
      ...
      <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "var(--md-surface-cont)", overflow: "hidden" }}>
        ...
        {/* Header */}
        <div style={{ display: "flex", alignItems: "center", padding: "6px 14px", gap: 8, borderBottom: "1px solid var(--md-outline-var)", background: "var(--md-surface-cont)", flexShrink: 0 }}>
          <div style={{ width: 20, height: 20, borderRadius: 5, background: "var(--md-primary)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg viewBox="0 0 24 24" width={12} height={12} fill="white"><path d="M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z" /></svg>
          </div>
          <div style={{ fontSize: 12, fontWeight: 600, color: "var(--md-on-surface)" }}>Admin</div>
          <button onClick={onClose} style={{ marginLeft: "auto", background: "none", border: "none", cursor: "pointer", color: "var(--md-on-surface)", opacity: 0.5, fontSize: 16, lineHeight: 1, padding: "2px 5px", borderRadius: 5 }}>×</button>
        </div>
